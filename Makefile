...
$U/_randomtest: $U/randomtest.o $(ULIB)
	$(LD) $(LDFLAGS) -N -e main -Ttext 0 -o $U/_randomtest $U/randomtest.o $K/rand.o $U/ulib.o $U/usys.o $U/printf.o
	$(OBJDUMP) -S $U/_randomtest > $U/randomtest.asm
